...
let showBoxes = () => {
  ...
  boxes.forEach((user) => {
    ...
    box += `<div class='box'>
        ...
        <img src="./Assests/save-modified.png" id="del_list" onclick="delBox(${user.id})" />
        <img src="./Assests/plus.png" id="add_list" onclick="addList(${user.id})" class="fas fa-plus-circle"></i>
    </div>`;
  });
      ...
      if (user.id == id) {
        ...
        <div class="page-2-btn">
                <div id="b-btn" onclick='goBack()'>
                  <img src="./Assests/Back4.png" width="40px" class="fas fa-chevron-circle-left fa-2x"></i
                  ><span class="w">back</span>
                </div>
              <div class="heading">${user.title}</div>
             <img src="./Assests/plus.png" width="40px"  class="fas fa-plus-circle fa-2x" onclick='addBoxes()'></i>
        </div>
        <hr>
        <hr>
        ...
        <div class='sbox'>
          ...
          <img src="./Assests/save-modified.png" id="s_del_list" onclick="delBox(${user.id})" />
          <img src="./Assests/plus.png" id="s_add_list" onclick="addList(${user.id})" />
      </div>`;
      }
    });
  } else {
